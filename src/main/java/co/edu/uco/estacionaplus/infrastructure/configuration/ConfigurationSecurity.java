...
public class ConfigurationSecurity
{
    ...
    public FilterRegistrationBean<AuthenticationFilter> authenticationFilter(ServiceValidateToken tokenValidationService)
    {
        ...
        registrationBean.setFilter(new AuthenticationFilter(tokenValidationService, new String[]{"/api/login","/api/parkings", "/api/users*", "/api/reservation*", "/swagger-ui.html","/swagger-ui/index.html","/v3/api-docs/swagger-config","/v3/api-docs", "*.js","*.css","*.png"}));
