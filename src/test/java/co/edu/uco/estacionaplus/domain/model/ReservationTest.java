...
public class ReservationTest
{
    ...
    {
        Assertions.assertEquals("The arrivalTime of a Reservation cannot be empty.",Assertions.assertThrows(IllegalArgumentException.class, () -> Reservation.create(1, new Date(), null, "14:00:00", ReservedTime.create(1, 1, "Horas"), Price.create(1, 2000), Place.create(1, "A1", true, TypePlace.create(1, "Moto")), PaymentMethod.create(1, "Tarjeta"), User.create(1, "esteban", "colorado", "1038418594", "3228486049", "estebancolorado@gmail.com", "123456Aa", UserRole.create(1, "usuario"), Vehicle.create(1, "USV36D", TypeVehicle.create(1, "moto"))))).getMessage());
    }
